...
class SilverpoppperTest < Test::Unit::TestCase
  ...
  def test_schedule_mailing
    ...
    assert_equal '1878843', s.schedule_mailing(12345, 860866, 'My test mailing 4', 'Where mailing service', 'Bruno', 'testman@testman.com', 'testman@testman.com', {'TEST_PARAM' => 'This is external parameter generated by our system'})
  ...
  def test_schedule_mailing_fail
    ...
    assert_raise RuntimeError do
      s.schedule_mailing(12345, 860866, 'My test mailing 4', 'Where mailing service', 'Bruno', 'testman@testman.com', 'testman@testman.com', {'TEST_PARAM' => 'This is external parameter generated by our system'})
    end
  end
...
<Envelope>
 <Body>
  <ScheduleMailing>
   ...
   <SEND_HTML/>
   <SEND_TEXT/>
   <MAILING_NAME>My test mailing 4</MAILING_NAME>
   <SUBJECT>Where mailing service</SUBJECT>
   <FROM_NAME>Bruno</FROM_NAME>
